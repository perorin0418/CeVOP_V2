	...
	public CeCombo() {
		...
		this.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				CeCombo.this.setForeground(CeCommon.colorFontInactive);
				if (focus != null) {
					focus.focusLost();
				}
			}
			...
			public void focusGained(FocusEvent e) {
				CeCombo.this.setForeground(CeCommon.colorFontActive);
				if (focus != null) {
					focus.focusIn();
				}
			}
		...
		this.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				int index = CeCombo.this.getSelectedIndex() + e.getWheelRotation();
				if (index < 0) {
					index = 0;
				} else if (index > CeCombo.this.getItemCount() - 1) {
					index = CeCombo.this.getItemCount() - 1;
				}
				CeCombo.this.setSelectedIndex(index);
			}
		});
	}
