...
import org.net.perorin.swingParts.parts.stringLimitation.NumberCharOnly;
	...
	public CeTextField() {
		...
		this.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				CeTextField.this.setForeground(CeCommon.colorFontInactive);
				if (focus != null) {
					focus.focusLost();
				}
			}
			...
			public void focusGained(FocusEvent e) {
				CeTextField.this.setForeground(CeCommon.colorFontActive);
				if (focus != null) {
					focus.focusIn();
				}
